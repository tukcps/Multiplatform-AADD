package io.github.tukcps.aadd.lpsolver
import io.github.tukcps.aadd.lpsolver.LpConstraintSign.*
import io.github.tukcps.aadd.lpsolver.LpFunctionOptimization.*
import io.github.tukcps.aadd.lpsolver.Verdict.*
...
fun solve(problem: LpProblem): LpSolution {
    ...
    writeTerms(problem.function.expression.terms, initialState.c, if (problem.function.optimization == MAXIMIZE) +1 else -1)
