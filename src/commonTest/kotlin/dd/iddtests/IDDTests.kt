...
class IDDTests {
    ...
    fun testIDDAssignment() {
        DDBuilder {
            val a = integer(10)
            assertEquals(10, a.getRange().min.finiteValue)
            assertEquals(10, a.getRange().max.finiteValue)
        }
    }
    ...
    fun testIDDAddition() {
        DDBuilder {
            ...
            val b = integer(1)
            val r = a + b
            assertEquals(11, r.getRange().min.finiteValue)
            assertEquals(11, r.getRange().max.finiteValue)
        }
    }
    ...
    fun testIDDAddition2() {
        DDBuilder {
            ...
            val b = integer(2L..3)
            val c  = a + b
            assertEquals(3, c.min.finiteValue)
            assertEquals(5, c.max.finiteValue)
        }
    }
    ...
    fun testIDDSubtraction() {
        DDBuilder {
            ...
            val b = integer(1)
            val r = a - b
            assertEquals(9, r.min.finiteValue)
            assertEquals(9, r.max.finiteValue)
        }
    }
    ...
    fun testIDDMultiplication() {
        DDBuilder {
            ...
            val b = integer(2)
            val r = a * b
            assertEquals(20, r.min.finiteValue)
            assertEquals(20, r.max.finiteValue)
        }
    }
    ...
    fun testIDDDivision() {
        DDBuilder {
            ...
            val b = integer(5)
            val r = a / b
            assertEquals(2, r.min.finiteValue)
            assertEquals(2, r.max.finiteValue)
        }
    }
    ...
    fun infeasibilityTest() {
        DDBuilder{
            ...
            assertEquals(Bool.True, (c1 as BDD.Internal).T)
            assertEquals(Bool.False, (c1).F)
            // assertEquals("ITE(1, True, False)", c1.toIteString())
            val c2 = a lessThan integer(1)
            //println("c2 = " + c2.toIteString())
            assertEquals(Bool.False,(c2 as BDD.Internal).T)
            assertEquals(Bool.True,c2.F)
    ...
    fun testMultiplication2() {
        DDBuilder {
            ...
            val b = integer(2L..3)
            val c = a * b
            assertEquals(14, c.min.finiteValue)
            assertEquals(30, c.max.finiteValue)
        }
    }
