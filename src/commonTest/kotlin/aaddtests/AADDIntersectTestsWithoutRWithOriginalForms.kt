...
class AADDIntersectTestsWithoutRWithOriginalForms {
    ...
    fun intersectInfTest() {
        DDBuilder {
            ...
            this.config.noiseSymbolsFlag = true
            val a: AADD = Reals
            val b: AADD.Leaf = real(1.0..2.0, "b")
    ...
    /** Intersection with single value and Reals gives single value. */
    @Test
    fun intersectPointReals() {
        DDBuilder {
            ...
            assertTrue( 4.0/3.0*1000000000.0 in  (b intersect Reals).getRange() )

            // no large over-approximation
            assertTrue( (b intersect  Reals ) in 13.33E8 .. 13.34E8)
            assertTrue( (Reals intersect b) in 13.33E8 .. 13.34E8)
