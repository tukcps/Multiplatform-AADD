...
class AffineFormFunctionsTest {
    ...
    fun testPowFxn() {
        DDBuilder {
            val a = AffineForm.range(this, 2.0..3.0, "1")
            val b = 2.0
            val c = AffineForm.range(this, 3.0..3.0, "1")

            var d : AffineForm = pow(a, b)
            //println("d = " + d)
            assertEquals(4.0, d.min.toDouble(), 0.001)
            assertEquals(9.0, d.max.toDouble(), 0.001)
            //println("a = " + a)
            //println("b = " + b)
            d = pow(a, c)
            //println("d = " + d)
            assertEquals(8.0, d.min.toDouble(), 0.001)
            assertEquals(27.0, d.max.toDouble(), 0.001)
        }
    }
    ...
    fun testLogBaseFxn() {
        DDBuilder {
            val a = AffineForm.range(this, 1.0..1.0, "1")
            var b = log(10.0, a, 10.0)

            //println("a = " + a)
            //println("b = " + b)
            DDTest.assertEquals(0.0..0.0, b, 0.001)
            b = log(10.0, AffineForm.range(this, 100.0..100.0, "1"))
            //println("b = " + b)
            assertEquals(2.0, b.min, 0.001)
            assertEquals(2.0, b.max, 0.001)
            b = log(5.0, AffineForm.range(this, 100.0..100.0, "1"))
            //println("b = " + b)
            assertEquals(ln(100.0) / ln(5.0), b.min.toDouble(), 0.001)
            assertEquals(ln(100.0) / ln(5.0), b.max.toDouble(), 0.001)
            b = log(2.0, AffineForm.range(this, 128.0..128.0, "1"))
            //println("b = " + b)
    ...
    fun testAffineFormPlus() {
        ...
        assertFailsWith<DDInternalError> {
            val myAffine = create(builder, realRange, central, r, xi)
            ...
            yi[1] = 3.0
            yi[2] = 1.0
            val affineToAdd = create(builder, realRange2, central2, r2, yi)
    ...
    fun test2AffineFormPlus() {
        ...
        val realRange = RealRange(min.toDoubleBound()!!, 15.0.toDoubleBound()!!)
        val xi = HashMap<Long, Double>()
        xi[1] = 2.0
        xi[2] = 4.0

        val yi = HashMap<Long, Double>()
        val sharedNoise = xi[1L]
        if (sharedNoise != null) {
            yi[1L] = sharedNoise
        }
        yi[2L] = 3.0
        ...
        val central = 5.0
        DDBuilder {
            val a = create(this, realRange.min, realRange.max, central, r, xi)
    ...
    fun test4AffineFormPlus() {
        ...
        val central = 5.0
        DDBuilder {
            val a = create(this, realRange, central, r, xi)
            val b = create(this, RealRange(10.0, 20.0), 8.0, 1.0, yi)
            val addingTwoAF = a.plus(b)
            assertEquals(13.0, addingTwoAF.central, .01)
        }
    ...
    fun test5AffineFormPlus() {
        val max: Double = Double.POSITIVE_INFINITY
        val realRange = RealRange(DoubleBound.NegativeInfinity, 15.0.toDoubleBound()!!)
        val xi = HashMap<Long, Double>()
        xi[1L] = 2.0
        xi[2L] = 4.0
        ...
        DDBuilder {
            val a = create(this, realRange, central, r, xi)
            val b = create(this, RealRange(10.0.toDoubleBound()!!, max.toDoubleBound()!!), 8.0, 1.0, yi)
            val addingTwoAF = a.plus(b)
            assertEquals(13.0, addingTwoAF.central, .01)
        }
    }
    ...
    fun testAffineFormMinus() {
        ...
        xi[1] = 50.0
        xi[2] = 75.0
        val myAffineA = create(builder, realRange.min, realRange.max, central, r, xi)
        ...
        yi[1] = 2.0
        yi[2] = 4.0
        val myAffineB = create(builder, realRange2.min, realRange2.max, central2, r2, yi)
    ...
    fun test2AffineFormTimes() {
        ...
        DDBuilder {
            val a = create(this, RealRange(min.toDoubleBound()!!, 15.0.toDoubleBound()!!), 5.0, 2.0, xi)
            val b = create(this, RealRange(10.0.toDoubleBound()!!, max.toDoubleBound()!!), 8.0, 1.0, yi)
            val multipliedTwoAF = a.times(b)
            assertEquals(40.0, multipliedTwoAF.central, .01)
        }
    ...
    fun test3AffineFormTimes() {
        ...
        xi[3] = 4.9
        DDBuilder {
            val a = create(this, RealRange(2.0, 50.0), 5.0, 1.0, xi)
            val b = AffineForm.scalar(this, 11.0)
    ...
    fun test1AffineFormExp() {
        ...
        xi[3] = 4.9
        DDBuilder {
            val a = create(this, RealRange(2.0, 50.0), 4.0, 1.0, xi)
            val b = exp(a)
            assertEquals(7.3896, b.min.toDouble(), .01)
        }
    }
    ...
    fun test2AffineFormExp() {
        ...
        xi[3] = 4.9
        DDBuilder {
            val a = create(this, RealRange(-2.0, 10.0), 4.0, 1.0, xi)
            val b = exp(a)
            assertEquals(0.135, b.min.toDouble(), .01)
        }
    }
    ...
    fun test3AffineFormExp() {
        ...
        xi[3] = 4.9
        DDBuilder {
            val a = create(this, RealRange(-10.0, -2.0), 4.0, 1.0, xi)
            val b = a.exp()
    ...
    fun test5AffineFormExp() {
        ...
        val min: Double = Double.NEGATIVE_INFINITY
        DDBuilder {
            val a = create(this, RealRange(min, 4.0), 4.0, 1.0, xi)
            val b = a.exp()
    ...
    fun testOfAffineFunInv() {
        DDBuilder {
            val a = create(this, RealRange(3.0, 7.0), 5.0, 0.0, hashMapOf(1 to 2.0))
    ...
    fun testOfAffineFunInv2() {
        ...
        xi[4] = -2.5
        DDBuilder {
            val a = create(this, RealRange(-7.0, 3.0), 5.0, 3.0, xi) //-6.5..3.0
    ...
    fun testOfAffineFunInv3() {
        ...
        xi[1] = 2.0
        DDBuilder {
            val a = create(this, RealRange(2.0, 7.0), 5.0, 0.0, xi) // 3.0..7.0
            val b = a.inv() // 1.0/7.0..1.0/3.0
            assertEquals(1.0/7.0, b.min, precision)
            assertEquals(1.0/3.0, b.max, precision)
        }
    ...
    fun testOfAffineFunInv4() {
        DDBuilder {
            val a = create(this, 2.0..7.0, 5.0, 2.0, hashMapOf(1 to 2.0))
    ...
    fun testOfAffineFunInv5() {
        ...
        DDBuilder {
            val a = create(this, RealRange(1.0, 12.0), 5.0, 3.0, xi) // 1.0..12.0, central + xi + r > 12, central - xi - r < 1
    ...
    fun testOfAffineFunInv6() {
        ...
        xi[1] = 2.0
        DDBuilder {
            val a = create(this, RealRange(-7.0, -2.0), 12.0, 1.0, xi)
    ...
    fun testOfAffineFunInv7() {
        ...
        xi[1] = 2.0
        DDBuilder {
            val a = create(this, RealRange(-2.5, -1.0), 12.0, 3.0, xi) // again no intersection --> NaN???
            val b = a.inv()
            println(b.min)
            println(b.max)
            //TODO: min > max --> NaN ?
    ...
    fun testOfAffineFunSqrtMin1() {
        ...
        xi[1] = 2.0
        DDBuilder {
            val a = create(this, RealRange(2.0, 4.0), 4.0, 2.0, xi) // central + xi + r = 8.0, central - xi - r = 0.0 --> 2.0..4.0
    ...
    fun testOfAffineFunSqrtMin2() {
        ...
        xi[1] = 2.0
        DDBuilder {
            val a = create(this, RealRange(-4.0, -2.0), 4.0, 2.0, xi) // central + xi + r = 8.0, central - xi - r = 0.0 --> no intersection --> NaN?
    ...
    fun testOfAffineFunSqrtMin3() {
        ...
        xi[3] = 1.0
        DDBuilder {
            val a = create(this, RealRange(2.0, 3.0), 5.0, 2.0, xi) // central + xi + r = 13.0, central - xi - r = -2.0 --> 2.0..3.0
    ...
    fun testOfAffineFunSqrtMin4() {
        DDBuilder {
            ...
            val a = create(this, RealRange(-2.0, 3.0), 5.0, 2.0, xi)
    ...
    fun testOfAffineSin() {
        ...
        xi[2] = 0.3
        DDBuilder {
            val a = create(this, RealRange(0.0, 1.0), 0.5, 1.0, xi) // central - xi - r = -1.0, central + xi + r = 2.0 --> 0.0..1.0
    ...
    fun testAffineSin4() {
        ...
        xi[2] = 3.0
        DDBuilder {
            val a = create(this, RealRange(7.0, 10.0), 2.0, 1.0, xi) // central - xi - r = -4.0, central + xi + r = 8.0 --> 7.0..8.0
    ...
    fun testAffinePow2() {
        ...
        yi[2] = 1.5
        DDBuilder {
            val a = create(this, RealRange(0.9, 5.0), 2.0, 1.0, xi)
            val b = create(this, RealRange(0.5, 3.0), 2.1, 1.0, yi)
            val c = a.pow(b)
    ...
    fun testAffinePow4() {
        ...
        DDBuilder {
            val a = create(this, RealRange(2.5, 5.0), 1.5, 1.0, xi)
            val b = a.pow(2.0)
            val c = a.times(a)
    ...
    fun testAffineCos2(){
        DDBuilder {
            val a = create(this, 0.1..1.0, 0.5, 1.0, hashMapOf(1 to 0.2, 2 to 0.3))
    ...
    fun testAffineCos3(){
        DDBuilder{
            val a = create(this, 0.2 .. 1.0, 0.5, 1.0, hashMapOf(1 to 0.2, 2 to 0.3))
            // central - xi - r = -1.0, central + xi + r = 2.0 --> 0.0..1.0
    ...
    fun testArcSin01(){
        DDBuilder{
            val xi = HashMap<Int, Double>()
            xi [1] = 0.5
            val a = create(this, -1.0 .. 1.0, 0.0, 0.5, hashMapOf(1 to 0.5))
            val b = a.arcsin()
    ...
    fun testArcSin02(){
        DDBuilder{
            val a = create(this, -1.0..1.0, 0.0, 1.0, hashMapOf(1 to 0.0))
            val b = a.arcsin()
            assertTrue(asin(a.max)-b.max <= 0.0)
            assertTrue(asin(a.min)-b.min >= 0.0)
            assertEquals(asin(a.min), b.min, precision)
    ...
    fun testArcSin1(){
        DDBuilder {
            val a = create(this, -0.5 .. 0.5, 0.0, 0.0, hashMapOf(1 to 0.5))
            val b = a.arcsin()
            assertTrue(asin(a.max)-b.max <= 0.0)
            assertTrue(asin(a.min)-b.min >= 0.0)
    ...
    fun testArcSin2(){
        DDBuilder {
            val a = create(this, -1.0 .. 1.0, 0.0, 0.0, hashMapOf(1 to 1.0))
            val b = a.arcsin()
            assertTrue(asin(a.max)-b.max <= 0.0)
            assertTrue(asin(a.min)-b.min >= 0.0)
    ...
    fun testArcSin4(){
        DDBuilder {
            val a = create(this, -0.2 .. 0.8, 0.3, 0.0, hashMapOf(1 to 0.5))
            val b = a.arcsin()
            assertTrue(asin(a.max)-b.max <= 0.0)
            assertTrue(asin(a.min)-b.min >= 0.0)
    ...
    fun testArcCos1(){
        DDBuilder{
            val xi = HashMap<Int, Double>()
            xi [1] = 0.5
            val a = create(this, RealRange(-0.5,0.5), 0.0, 0.0, xi)
            val b = a.arccos()
            assertTrue(acos(a.min)-b.max <= 0.0)
            assertTrue(acos(a.max)-b.min >= 0.0)
