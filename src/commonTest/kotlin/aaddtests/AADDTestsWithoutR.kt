...
internal class AADDTestsWithoutR {
    ...
    fun infeasibilityTest() {
        DDBuilder {
            ...
            val a = this.real(0.0..1.0, "i")
            val b = this.real(3.0..4.0, "i")
    ...
    fun negate() {
        DDBuilder {
            ...
            // This assertion or the above assertions fail if merging when considering the
            // quantization error prevents merge.
    ...
    fun expTest() {
        DDBuilder {
            ...
            assertEquals(0.0, exp3.value.r, PRECISION_EXP_MINUS_2)
    ...
    fun logTest() {
        DDBuilder {
            ...
            assertEquals(0.0, log1.r, PRECISION_EXP_MINUS_2)
            ...
            assertEquals(0.0, log2.r, PRECISION_EXP_MINUS_2)
            ...
            assertEquals(0.0, log3.value.r, PRECISION_EXP_MINUS_2)
    ...
    fun invTest() {
        DDBuilder {
            ...
            assertEquals(0.0, inv3.r, PRECISION_EXP_MINUS_6)
