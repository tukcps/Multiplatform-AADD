 ...
 */
operator fun DoubleBound.plus(other: DoubleBound): DoubleBound? = (this.toDouble() + other.toDouble()).toDoubleBound()
operator fun DoubleBound.plus(other: Double): DoubleBound? = (this.toDouble() + other).toDoubleBound()
